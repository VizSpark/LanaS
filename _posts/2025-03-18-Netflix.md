...
![Alt text describing image output_143_0]({{ '/assets/img/step two.png' | relative_url }})

![Alt text describing image output_143_0]({{ '/assets/img/step three.png' | relative_url }})
